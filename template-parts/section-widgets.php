...
$title = $purnava_options['sections-widgets-title'];
$content = $purnava_options['sections-widgets-content'];
$widget_layout = $purnava_options['sections-widgets-layout'];
...
?>
<section id="section-widgets" class="<?php if(@$purnava_options['sections-widgets-background-type'] == 1) echo @$purnava_options['sections-widgets-background'] . ' ';?><?php if(@$purnava_options['sections-widgets-color-type'] == 1) echo @$purnava_options['sections-widgets-color'];?>">
