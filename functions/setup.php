<?php
//Add theme setup
if ( ! function_exists( 'purnava_setup' ) ) :
	function purnava_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'purnava'),
			'mobilemenu' => __('Mobile Menu', 'purnava'),
		));
...
add_action( 'after_setup_theme', 'purnava_setup' );