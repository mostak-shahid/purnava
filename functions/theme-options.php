<?php
    ...
    foreach ($product_cats as $product_cat) {
        $product_cat_arr[$product_cat['term_id']] = $product_cat['name'];
    }
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'mode'     => 'css',
                'theme'    => 'monokai',
                //'desc'     => 'Possible modes can be found at <a href="' . 'http://' . 'ace.c9.io" target="_purnava">' . 'http://' . 'ace.c9.io/</a>.',
                //'default'  => "body{\n   margin: 0 auto;\n}"
            ),
            array(
                'id'       => 'misc-settings-js',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(  
            ...
            array(
                'id'       => 'sections-title-background-image',
                'type'     => 'background',
                'output'   => array( '#page-title' ),
                'title'    => __( 'Section Background Image', 'redux-framework-demo' ),
                //'default'   => '#FFFFFF',
    ...
    //Ads Section
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Ads Section', 'redux-framework-demo' ),
        'id'               => 'sections-ads',
        'subsection'       => true,
        'desc'             => '',
        'customizer_width' => '450px',
        ...
        'fields'     => array(
            array(
                'id'             => 'sections-ads-padding',
                'type'           => 'spacing',
                'mode'           => 'padding',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
                'units_extended' => 'true',
                'output'         => array( '#section-ads .content-wrap' ),
                'title'          => __( 'Section Padding', 'redux-framework-demo' ),
            ),  
            array(
                'id'             => 'sections-ads-margin',
                'type'           => 'spacing',
                'mode'           => 'margin',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
            ...
            array(
                ...
                'required' => array( 'sections-ads-color-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-ads-color-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Select Color', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-ads-color-type', '=', '2' ),
                'output'         => array( '#section-ads' ),
                'mode'     => 'color',
                'validate' => 'colorrgba',
            ),
            array(
                'id'       => 'sections-ads-link-color',
                'type'     => 'link_color',
                'title'    => __('Links Color Option', 'redux-framework-demo'),
                'validate' => 'color',
                'output'         => array( '#section-ads a' ),
            ),
            array(
                'id'       => 'sections-ads-background-type',
                'type'     => 'button_set',
                'title'    => __( 'Section Background Type', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                ...
                'required' => array( 'sections-ads-background-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-ads-background-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-ads-background-type', '=', '2' ),
                'output'         => array( '#section-ads' ),
                'mode'     => 'background-color',
                'validate' => 'colorrgba',
            ),
    ...
    //Category Section
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Category Section', 'redux-framework-demo' ),
        'id'               => 'sections-pcategory',
        'subsection'       => true,
        'desc'             => '',
        'customizer_width' => '450px',
        'icon'             => 'el el-move',
        'fields'     => array(
            array(
                'id'             => 'sections-pcategory-padding',
                'type'           => 'spacing',
                'mode'           => 'padding',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
                'units_extended' => 'true',
                'output'         => array( '#section-pcategory .content-wrap' ),
                'title'          => __( 'Section Padding', 'redux-framework-demo' ),
            ),  
            array(
                'id'             => 'sections-pcategory-margin',
                'type'           => 'spacing',
                'mode'           => 'margin',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
            ...
            array(
                'id'       => 'sections-pcategory-color-type',
                'type'     => 'button_set',
                'title'    => __( 'Section text color', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                ...
                'required' => array( 'sections-pcategory-color-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-pcategory-color-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Select Color', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-pcategory-color-type', '=', '2' ),
                'output'         => array( '#section-pcategory' ),
                'mode'     => 'color',
                'validate' => 'colorrgba',
            ),
            array(
                'id'       => 'sections-pcategory-link-color',
                'type'     => 'link_color',
                'title'    => __('Links Color Option', 'redux-framework-demo'),
                'validate' => 'color',
                'output'         => array( '#section-pcategory a' ),
            ),
            array(
                'id'       => 'sections-pcategory-background-type',
                'type'     => 'button_set',
                'title'    => __( 'Section Background Type', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                'id'       => 'sections-pcategory-background',
                'type'     => 'select',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                //Must provide key => value pairs for select options
                'options'  => array(
                ...
                'required' => array( 'sections-pcategory-background-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-pcategory-background-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-pcategory-background-type', '=', '2' ),
                'output'         => array( '#section-pcategory' ),
                'mode'     => 'background-color',
                'validate' => 'colorrgba',
            ),
    ...
    //Top Selling
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Top Selling', 'redux-framework-demo' ),
        'id'               => 'sections-topselling',
        'subsection'       => true,
        'desc'             => '',
        'customizer_width' => '450px',
        'icon'             => 'el el-move',
        'fields'     => array(
            array(
                'id'             => 'sections-topselling-padding',
                'type'           => 'spacing',
                'mode'           => 'padding',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
                'units_extended' => 'true',
                'output'         => array( '#section-topselling .content-wrap' ),
                'title'          => __( 'Section Padding', 'redux-framework-demo' ),
            ),  
            array(
                'id'             => 'sections-topselling-margin',
                'type'           => 'spacing',
                'mode'           => 'margin',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
            ...
            array(
                'id'      => 'sections-topselling-content',
                'type'    => 'editor',
                'title'   => __( 'Section Content', 'redux-framework-demo' ),
                'args'    => array(
                    'wpautop'       => false,
            ...
            array(
                'id'          => 'sections-topselling-slides',
                'type'        => 'mos_slides', //'mos_services_slides'
                'title'       => __( 'Section Details', 'redux-framework-demo' ),              
                'show' => array(
                    'title' => true,
                    'description' => true,
            ...
            array(
                'id'       => 'sections-topselling-color-type',
                'type'     => 'button_set',
                'title'    => __( 'Section text color', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                ...
                'required' => array( 'sections-topselling-color-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-topselling-color-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Select Color', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-topselling-color-type', '=', '2' ),
                'output'         => array( '#section-topselling' ),
                'mode'     => 'color',
                'validate' => 'colorrgba',
            ),
            array(
                'id'       => 'sections-topselling-link-color',
                'type'     => 'link_color',
                'title'    => __('Links Color Option', 'redux-framework-demo'),
                'validate' => 'color',
                'output'         => array( '#section-topselling a' ),
            ),
            array(
                'id'       => 'sections-topselling-background-type',
                'type'     => 'button_set',
                'title'    => __( 'Section Background Type', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                'id'       => 'sections-topselling-background',
                'type'     => 'select',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                //Must provide key => value pairs for select options
                'options'  => array(
                ...
                'required' => array( 'sections-topselling-background-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-topselling-background-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-topselling-background-type', '=', '2' ),
                'output'         => array( '#section-topselling' ),
                'mode'     => 'background-color',
                'validate' => 'colorrgba',
            ),
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            ...
            $sections[] = array(
                ...
                // Leave this as a purnava section, no options just some intro text set above.
                'fields' => array()
            );
