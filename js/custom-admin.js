jQuery(document).ready(function($) {  
    ...
    $("button.add-category-banner").live("click", function(add){
        add.preventDefault();
        ...
        imageUploader.on("select", function(){
            ...
            console.log(image);
            button.siblings('input.mos_poduct_cat_img').val(image_link);
    ...
    function show_meta_boxes(page_template) {
        if(page_template == 'page-template/lightbox-page.php') {
            $('#_purnava_gallery_details').show();
        } else {
           $('#_purnava_gallery_details').hide(); 
        }
        if(page_template == 'page-template/gallery-page.php') {
            $('#_purnava_link_gallery_details').show();
        } else {
           $('#_purnava_link_gallery_details').hide();
        }
    }
